public class Main {
    public static void main(String[] args) {
        ...
        mobil1.ngebut(); // Output dari metode ngebut tanpa parameter

        System.out.println("\nInformasi Mobil 2:");
        mobil2.jalan("perjalanan jauh");
        mobil2.ngegas(15);
        mobil2.rodaMuter(true);
        mobil2.ngebut(120); // Output dari metode ngebut dengan parameter kecepatan

        System.out.println("\nInformasi Mobil 3:");
        mobil3.jalan("circuit");
        mobil3.ngegas(20);
        mobil3.rodaMuter(true);
        mobil3.ngebut("sirkuit Balap", 200); // Output dari metode ngebut dengan parameter lokasi dan kecepatan
    }
}
